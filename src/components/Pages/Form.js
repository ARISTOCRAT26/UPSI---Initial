...
function Form() {
  ...
  const loadData = async () => {
    await axios
      .get("http://localhost:16000/forms/unpublished")
  ...
  const handleFormClick = (form) => {
    ...
    navigate("/home/forms/form-maker", {
      state: {
        form: form,
      },
    });
  ...
  return (
    <Fragment>
      ...
      >
        <Grid item xs={12} sm={12} md={10} lg={10} xl={10}>
          <Paper elevation={3} sx={{ m: 2, p: 2 }} overflow="auto">
            ...
            <Stack direction={"row"} overflow="auto">
              ...
              >
                <Image src={plus} height="50%" fit="scale-down"/>
        ...
        <Grid item xs={12} sm={12} md={10} lg={10} xl={10}>
          <Paper elevation={3} sx={{ m: 2, p: 2 }} overflow="auto">
            <Typography variant="h5">Unpublished/Saved Forms</Typography>
            <Stack direction={"row"} overflow="auto">
        ...
        <Grid item xs={12} sm={12} md={10} lg={10} xl={10} overflow="auto">
          <Paper elevation={3} sx={{ m: 2 }}>
            <Box sx={{ p: 2 }}>
              <Typography variant="h5">Published Forms</Typography>
              <Table>
                <TableHead>
                  <TableRow>
