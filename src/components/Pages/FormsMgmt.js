...
function FormsMgmt() {
  ...
  const [renderForm, setRenderForm] = useState(data.formData);
  ...
  return (
    <Box overflow={"auto"}>
      <Typography variant="h4" gutterBottom m={1} p={1}>
        Form Management
      </Typography>
      <Grid container spacing={2} sx={{ m: 3, p: 3 }} maxHeight={"65vh"}>
